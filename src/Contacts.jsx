...
const Contacts = () => {
  ...
  return (
    ...
    <div className="">
        ...
        <div className="">
            <div className="">
                ...
                <div className="">
                    <input className='border-0 outline-none border-b-[1px] border-[#F0F0F0] w-[779px] py-[17px] font-dm' type="text" placeholder='Your name here' />
                </div>
            </div>
            ...
            <div className="">
                ...
                <div className="">
                    <input className='border-0 outline-none border-b-[1px] border-[#F0F0F0] w-[779px] py-[17px] font-dm' type="email" placeholder='Your email here' />
                </div>
            </div>


            <div className="">
                <label className='text-[16px] text-[#262626] font-dm font-bold leading-6' htmlFor="">Password</label>
                <div className="">
                    <input className='border-0 outline-none border-b-[1px] border-[#F0F0F0] w-[779px] py-[17px] font-dm' type="password" placeholder='Your password here' />
                </div>
            </div>
        </div>
    </div>
    ...
    <div className="pt-[30px]">
        <button className='text-[16px] text-[#262626] font-dm font-bold border-[1px] border-[#262626] py-[16px] px-[86px] hover:bg-[#262626] hover:text-[#fff] duration-500 ease-in-out'>Sign Up</button>
    </div>
